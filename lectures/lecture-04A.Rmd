...
df1 <- btw2009 %>%  mutate(Linke2 = 100 * LINKE2 / valid2)
skimr::skim(df1)
```
...
df1 %>% 
  mutate(color = case_when(state %in% east ~ "#E16A86",
         ...
         state = fct_reorder(state, Linke2)) %>% 
  ggplot(aes(Linke2, state)) + 
